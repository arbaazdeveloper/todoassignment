...
const Add = ({type,description,title}) => {
  return (
    <>
...
<h4 contentEditable={type==='add'?'true':'false'}>{title}</h4>
</div>
<div className='editble-btn'>
<div className='editible-btn-container'>
  { type==='add'? <div><svg width="14" height="15" viewBox="0 0 14 15" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<p contentEditable={type==='add'?'true':'false'}>{description}</p>
